...
class RegisterUser extends Component {
    ...
    handleRegistration(event) {
        ...
        this.props.addUser({ firstName, lastName, userName, password, email })
    ...
    render () {
        ...
        const { firstName, lastName, userName, password, email, error } = this.state
                                ...
                                <Paper elevation={1}>
                                    <form style={{display: "flex", flexDirection: "column", width: "30vw", padding: "5vh 5vw 5vh 5vw"}}>
                                        ...
                                        <Button variant="contained" style={{width: "10vw", height: "6vh", margin: 10}}
                                            onClick={handleRegistration} disabled={!firstName || !lastName || !userName || !password || !email || !isValidEmail(email)}>
                                            Register
                                        </Button>
                                        ...
                                        {
                                            error 
                                                ? <Typography variant="subheading" style={{ color: "red"}}>Error processing request. Please try again</Typography> 
                                                : ""
                                        }
                                    </form>
                                </Paper>
